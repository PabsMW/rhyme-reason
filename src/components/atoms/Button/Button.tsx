  ...
  if (variant === "primary") {
    return (
      <button
        ...
        disabled={disabled}
        className={cn(
          "font-sf-pro-rounded inline-flex min-h-[50px] min-w-[8rem] items-center justify-center rounded-full px-11 text-3xl font-semibold leading-none text-game-text-inverse shadow-btn-primary transition-colors",
